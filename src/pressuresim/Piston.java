...
public class Piston extends SpringInterface {
	...
	public Piston(int _x, int _y, int _k, int _length,String label, PApplet p, Box2DProcessing box2d, ResearchData rData){
