...
public class PistonFactory extends Component {
	...
	public PistonFactory(PApplet p, ControlP5 cp5, ResearchData rData, Canvas designCanvas, int _x, int _y, int _w, int _h) {
		super(_x,_y,_w,_h);
		parent = p;
		this.rData = rData;
